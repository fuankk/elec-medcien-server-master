...
@Service
public class BreathHeartSocketServer {
...
//                    onMessage(socket, breathHeartMonitor, flag);
    ...
    private static void Mess(Socket socket) throws IOException {
...
//                System.out.println("buf_len:" + len);
                ...
                String standby = "fa1902000300e2fc";//FA 19 02 00 03 00 E2 FC
                ...
                if (a.startsWith(standby) && notice) {
                    ...
                    System.out.println("收到待机指令 + Client saying:" + a);
                    ...
                    if (notice) {
                        //发送开机指令
                        out.write(socketTools.hexStringToByteArray("FA 16 02 00 01 00 EF FC"));
                        out.flush();
                        notice = false;
                        clock[0] = 0;
                        System.out.println("呼吸心跳开机指令已发出");
                    }
                } else if (!notice && !a.startsWith(standby)) {
                    //如果为假  进行操作并插入
                    System.out.println("收到呼吸心跳客户端信息指令： " + a);
                    int str_index = a.indexOf("fa1571");
...
//                    System.out.println(f_heartRate_Out);
                        ...
                        System.out.println("outputFilterBreathOut:" + f_outputFilterBreathOut);
                        System.out.println("outputFilterHeartOut:" + f_outputFilterHeartOut);
                        System.out.println("BreathingRate_Out:" + f_BreathingRate_Out);
                        System.out.println("heartRate_Out:" + f_heartRate_Out);
